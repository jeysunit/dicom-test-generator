...
def test_generation_config_invalid_calendar_date_feb29_nonleap() -> None:
    with pytest.raises(ValidationError, match="invalid_calendar_date"):
        GenerationConfig(
            job_name="job-invalid-calendar",
            output_dir="/tmp/output",
            patient=Patient(
                patient_id="P000001",
                patient_name=PatientName(alphabetic="YAMADA^TARO"),
